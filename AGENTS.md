...
<!-- Preserved from this repository's own `AGENTS.md` as it stood before it adopted the
     aivara-se agent convention (version 1, commit cdf6ee29d25447643dcc40410024d167990f9014). Nothing was deleted: every heading is two
...
### AGENTS.md — maintaining MiMi's personal site

This repository is MiMi's own website: `index.html` (one screen) and `log.html` (a dated
...
- **One accent hue: `#7aede2`.** It is used for links, the avatar ring and small highlights,
